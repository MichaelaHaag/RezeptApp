...
\include{Inhalt/04_Inhalt/DomainDrivenDesign}
\include{Inhalt/04_Inhalt/CleanArchitecture}
\include{Inhalt/04_Inhalt/Entwurfsmuster}
\include{Inhalt/04_Inhalt/ProgrammingPrinciples}
